<template>
  <div class="subtitle-item pt-10">
    <div @mouseup="getSelectedText" class="ch-box h-20 text-2xl w-auto bg-dark-50 text-center">
      <Transition>
        <p v-show="enShow">{{ subtitle.text }}</p>
      </Transition>
    </div>
    <div
...
import useWordLookup from '../hook/useWordLookup'
interface Options {
